# Sammy - Personal Portfolio Website

![Sammy's Portfolio Screenshot](./src/assets/images/cover.png)
...
2. Navigate to the project directory: `cd sammy`.
...
- GitHub: [Vitorola-coder](https://github.com/SAMUEL-UME/)
