        ...
        <div className="flex flex-col items-start flex-1 md:flex md:flex-row md:gap-10 md:items-center lg:flex lg:flex-row lg:items-center lg:space-x-12 lg:justify-between">
          <div>
            <div className={`gradientText`}>
              ...
              >
                Creative and Inspired Frontend Developer<span>.</span>
              </h1>
            </div>
            <p
            ...
            >
              I love to create solid and mindblowing frontend products with great and easier accessibilities for user-free experiences.
            </p>
            <div
              id="intro"
            ...
            >
              <p className={`max-w-[310px]`}>
                One Year of full experience and much more to anticipate, Also specialized in building products, while
                ensuring a seamless web experience for clients within Africa and beyond globe.
              </p>
            ...
            <div className="mt-[35px] md:mt-[65px] flex justify-start items-center  gap-[26px] md:gap-[40px]">
              <motion.a
                href="https://www.instagram.com/d_techsoftware_guru/"
                target="_blank"
                rel="noreferrer"
                whileTap={{ scale: 1.1 }}
