    ...
    <>
      <div className={`flex flex-col ml-3 lg:items-end`}>
        ...
        <div className="flex flex-row relative z-[10000000000]  lg:justify-between mt-[30px]">
          <div className="w-0.5 h-[1140px] bg-[#1ED7601A]"></div>
          ...
          <div className="flex gap-[28px] lg:gap-[48px]">
              ...
              <div>
                <h3 className="font-semibold text-white lg:text-[30px] lg:leading-[30px] mt-[80px]  ">
                ...
                <p
                  className={`text-[#1ED760] font-semibold md:mt-[10px] text-[28px] leading-[37px]`}
                >
                ...
                >
                As a frontend engineer, I was taught to handle all aspects of the frontend, from translating designs into functional code to ensuring performance and responsiveness.
                 I work closely with creative developers who were my Tutors to integrate the frontend with backend systems and deliver a seamless user experience.
                 </h5>
              </div>
          </div>
            ...
            >
              ...
              >
                <span className="cursor-pointer bg-gradient-to-r max-w-[197px] mt-[550px] lg:max-w-[252px] to-[#D9D9D9] from-[#D9D9D900] py-0.5 pr-0.5">
